...
/* harmony import */ var _tagList_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tagList.js */ "./assets/js/tagList.js");

var pos2 = 0,
    pos4 = 0; // 해당 기능 전체에서 사용할 변수를 초기화 합니다. 

var element, whenMouseHover, colorBarTooltip, setPlanPopUp, setPlanTagColor, setPlanTagSelect;
var COLORBAR_HEIGHT = 630;
...
function setPlanOnLoad() {
  ...
  var value = setPlanTagSelect.value;
  setPlanTagColor.style.backgroundColor = _tagList_js__WEBPACK_IMPORTED_MODULE_0__["tagList"]["".concat(value)].color;
...
function tooltipTime(valueY) {
  var unitMinute = COLORBAR_HEIGHT / 19 / 6; // 5.52...px(10분)

  var hour = 6,
      minute = 0;

  if (valueY >= 6) {
    var time = 360 + Math.round(valueY / unitMinute) * 10;
    hour = Math.floor(time / 60);
    minute = time % 60;
    return "".concat(hour < 10 ? "0".concat(hour) : hour, ":").concat(minute < 10 ? "0".concat(minute) : minute);
  } else {
    return "06:00";
  }
}
...
function hoverMove(e) {
  ...
  whenMouseHover.style.top = "".concat(e.offsetY, "px");
  ...
  console.log("y = ".concat(pos4));
}

function dragPainting() {}

function clickedDrag(e) {
  // mouse clicked drag
  ...
  whenMouseHover.style.top = "".concat(e.offsetY, "px");
  var movedPos = e.offsetY - pos4; // 기존의 마우스 위치값을 비교하여 움직인 새로운 y좌표를 구하여 pos2에 저장합니다. 

  console.log("".concat(movedPos, " moved")); // pos4 = e.offsetY; // 다시 새로운 y좌표를 pos3에 저장합니다. 
  // element.style.top = (element.offsetTop - pos2) + "px"; // 요소의 y위치를 변경합니다. (마우스에 따라 요소가 y방향으로 움직입니다) 

  colorBarTooltip.innerHTML = tooltipTime(e.offsetY);
  console.log("offsetY = ".concat(e.offsetY));
}
...
function closeDragElement() {
  ...
  var option = "width= 310px, height = 100px, top=200px, left=200px";
  ...
  var setPlanExitInterval = window.setInterval(function () {
    try {
      if (setPlanPopUp.closed) {
        ...
        element.onmouseover = onMouseOver; // closeCallback(setPlanPopUp);
      }
    } catch (e) {}
  }, 1000);
}
...
function onMouseOver(e) {
  ...
  colorBarTooltip.innerHTML = tooltipTime(e.offsetY);
  whenMouseHover.style.top = "".concat(e.offsetY, "px");
  whenMouseHover.classList.add("showing"); // element.style.after.backgroundColor = "blue";
...
function dragElement(element) {
  ...
  element.onmousedown = dragMouseDown; // 요소를 마우스로 눌렀을 경우 dragMouseDown()을 실행 시키게 됩니다 
}

function colorbarLinePainting() {
  var unitSize = COLORBAR_HEIGHT / 19; // 33.157...px(1시간)

  for (var i = 1; i < 19; ++i) {
    var line = document.createElement("span");
    line.classList.add("line");
    line.style.top = "".concat(unitSize * i, "px");
...
/***/ 3:
/*!*****************************************************!*\
  !*** multi @babel/polyfill ./assets/js/colorbar.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! C:\Users\se5ng\Desktop\test1029\project-1\assets\js\colorbar.js */"./assets/js/colorbar.js");
